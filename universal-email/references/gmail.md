...
9. If authentication fails after they filled the window (server responded, then rejected the secret): 「这个应用专用密码好像不对。去 https://myaccount.google.com/apppasswords 再生成一串，生成后跟我说，我会再弹出窗口。」
